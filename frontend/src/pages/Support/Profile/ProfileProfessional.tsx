...
function ProfileProfessional ()  {
  ...
  return (
    <Container maxWidth="xl">
      ...
      <Menu theme="dark" mode="horizontal" defaultSelectedKeys={["professional"]}>
      ...
      <Grid item xs={3}>
          <div className="profile-page-subhead">Professional Details</div>
        </Grid>
      <Grid item xs={8}>
          </Grid>
          <Grid item xs={1}>
      ...
      <Grid item xs={11}>
          <div className="profile-contents">Company Name: IIT Ropar</div>
        </Grid>
        <Grid item xs={1}>
      </Grid>
        <Grid item xs={11}>
          <div className="profile-contents">Role at the company: B.Tech</div>
        </Grid>
