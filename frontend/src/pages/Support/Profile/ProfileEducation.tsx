...
function ProfileEducation ()  {
  ...
  return (
    <Container maxWidth="xl">
      ...
      <Menu theme="dark" mode="horizontal" defaultSelectedKeys={["education"]}>
      ...
      <Grid item xs={3}>
          <div className="profile-page-subhead">Educational Details</div>
        </Grid>
      <Grid item xs={8}>
          </Grid>
          <Grid item xs={1}>
      ...
      <Grid item xs={11}>
          <div className="profile-contents">University Name: IIT Ropar</div>
        </Grid>
        <Grid item xs={1}>
      </Grid>
        <Grid item xs={11}>
          <div className="profile-contents">Degree: B.Tech</div>
        </Grid>
        <Grid item xs={1}>
      </Grid>
        <Grid item xs={11}>
          <div className="profile-contents">Score Obtained: 10</div>
        </Grid>
        <Grid item xs={1}>
      </Grid>
        <Grid item xs={11}>
        ...
        <Grid item xs={11}>
          <div className="profile-contents">End Date: 17/03/2021</div>
        </Grid>
