...
function ProfileContact ()  {
  ...
  return (
    <Container maxWidth="xl">
      ...
      <Menu theme="dark" mode="horizontal" defaultSelectedKeys={["contact"]}>
      ...
      <Grid item xs={3}>
          <div className="profile-page-subhead">Contact Information</div>
        </Grid>
      <Grid item xs={8}>
          </Grid>
          <Grid item xs={1}>
      ...
      <Grid item xs={11}>
          <div className="profile-contents">Address: India</div>
        </Grid>
        <Grid item xs={1}>
      </Grid>
        <Grid item xs={11}>
          <div className="profile-contents">Current City: Ropar</div>
        </Grid>
        <Grid item xs={1}>
      </Grid>
        <Grid item xs={11}>
          <div className="profile-contents">Hometown: Ropar</div>
        </Grid>
