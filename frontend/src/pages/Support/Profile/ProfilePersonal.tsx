...
function ProfilePersonal ()  {
  ...
  return (
    <Container maxWidth="xl">
      ...
      <Menu theme="dark" mode="horizontal" defaultSelectedKeys={["personal"]}>
      ...
      <Grid item xs={3}>
          <div className="profile-page-subhead">Personal Information</div>
        </Grid>
      <Grid item xs={8}>
          </Grid>
          <Grid item xs={1}>
      ...
      <Grid item xs={11}>
          <div className="profile-contents">Date of Birth: 17/03/2021</div>
        </Grid>
        <Grid item xs={1}>
      </Grid>
        <Grid item xs={11}>
          <div className="profile-contents">Relationship Status: Single</div>
        </Grid>
        <Grid item xs={1}>
      </Grid>
        <Grid item xs={11}>
          <div className="profile-contents">Wedding Anniversary: 17/03/2021</div>
        </Grid>
